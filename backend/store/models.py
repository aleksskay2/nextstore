...
class StoreAdmins(models.Model):
    ...
    dateUpdateAdmin = models.DateField(null=True, blank=True)
...
class Users(models.Model):
    ...
    addressUserStore = models.ImageField(upload_to='user_images/', null=True, blank=True)
    dateUpdateUser = models.DateField(null=True, blank=True)
