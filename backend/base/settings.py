...
# 🔥 Актуальные домены и IP сервера
DOMAIN_NAME = 'storechat.online'
SSLIP_DOMAIN = '201.34.128.186.sslip.io'  # Рабочий домен для обхода блокировок ТСПУ
...
# ✅ Все ссылки по умолчанию формируются через наш безопасный HTTPS домен
BACKEND_URL = os.environ.get('BACKEND_URL', f"https://{SSLIP_DOMAIN}")
