...
# Домены и IP сервера из .env
DOMAIN_NAME = os.environ.get('DOMAIN_NAME', 'storechat.online')
SSLIP_DOMAIN = os.environ.get('SSLIP_DOMAIN', '201.34.128.186.sslip.io')
VPS_IP = os.environ.get('VPS_IP', '201.34.128.186')
...
if os.environ.get('DATABASE_URL'):
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('DB_NAME', 'nextstore_db'),
            'USER': os.environ.get('DB_USER', 'nextstore_user'),
